...
namespace G3.Modules.Cities.EntityFramework.InMemory.Context
{
    /// <summary>
    /// In Memory context for quick testing only, all data will be lost when app closes
    /// </summary>
    public class InMemoryContext : DbContext, IContext
    {
        public InMemoryContext() : base(new DbContextOptionsBuilder().UseInMemoryDatabase("Test").Options)
        {
